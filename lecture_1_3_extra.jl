...
# ╔═╡ 679b75d0-1f7c-11ec-219a-61b1f82f1019
begin
...
# ╔═╡ 23596674-91c9-4f35-90d9-01b43ffe7ae0
begin
	img_source = "https://user-images.githubusercontent.com/6933510/108605549-fb28e180-73b4-11eb-8520-7e29db0cc965.png"
	img_original = load(download(img_source))
end

# ╔═╡ cd48af09-3adf-4a0f-970f-fc7fed611967
typeof(img_original)

# ╔═╡ 1ee39cbc-12fe-4487-9386-5a4735354f2d
md"""
Show figure
$(@bind show_grid CheckBox(default=true))
"""

# ╔═╡ aa04c8b1-d041-4e47-b8fa-3e25fdb6b083
begin
	white(c::RGB) = RGB(1,1,1)
	white(c::RGBA) = RGBA(1,1,1,0.75)
end

# ╔═╡ 66ff59f9-6b6e-408f-8c2a-383419ca0255
...
# ╔═╡ cb691126-08ec-473a-a74e-40283c77d2a2
...
# ╔═╡ f42de0c5-9251-48d0-9350-15488168ddb4
img = if show_grid
...
# ╔═╡ 05e94aad-2b59-409b-b9c7-8f8bcf50504d


# ╔═╡ 766766ce-9292-4750-8c88-1da946511c1e


# ╔═╡ 796aae2a-4c9c-405a-8c7f-73d62824428b


# ╔═╡ b4d96dee-9f58-419d-a08c-d48d0cd2ddf1


# ╔═╡ ddf8e399-57b8-4c15-8db7-60aaff2740ec
